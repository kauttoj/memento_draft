...
save('memento_LOOPER_results_ORIG.mat','counts','radius_array','delay_array','-v7.3');
...
for radius = radius_array
    ...
    for delay = delay_array
        ...
        cd(home)
        save('memento_LOOPER_results_ORIG.mat','all_cormaps','counts','radius_array','delay_array','-v7.3');
