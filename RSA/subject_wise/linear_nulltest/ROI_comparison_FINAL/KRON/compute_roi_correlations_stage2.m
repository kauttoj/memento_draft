...
MOVIE_LENGTHS = [34*60+2,33*60+15,32*60 + 52];
...
for l=1:length(DELAYS)
    ...
    for i=1:length(TIMING_data)
        ...
        k=k+1;
        [fmri_volumes,volume_times,BOLD_envelope_fmri] = give_BOLD_envelope(TIMING_data(i).FIRST_time(1)+DELAY,EVENT_DURATION,TR,first_volume_offset,0.45);
