...
for i=1:length(TIMING_data)     
    ...
    k=k+1;    
    [fmri_volumes,volume_times,BOLD_envelope_fmri] = give_BOLD_envelope(TIMING_data(i).FIRST_time(1),EVENT_DURATION,TR,first_volume_offset,0.49);    
    ...
    k=k+1;
    [fmri_volumes,volume_times,BOLD_envelope_fmri] = give_BOLD_envelope(TIMING_data(i).SECOND_time(1)-5,EVENT_DURATION,TR,first_volume_offset,0.49);
    %averaged_volumes(k).volumes = fmri_volumes;
