...
for i=1:length(MOVIE_SEGMENTS)
    ...
    if ismember(MOVIE_SEGMENTS(i).ID,SELECTED_IDs)>0     
        if diff(MOVIE_SEGMENTS(i).ORIGINAL_time)>100-eps                      
            ind(end+1)=i;
...
ORIGINAL_SUBJ = {'S7','S8', 'S9', 'S10','S12','S13','S15','S16','S17','S19','S21','S22','S23'}; % S13 incomplete
...
KRON_SUBJ = {'KRON_2','KRON_3','KRON_5','KRON_6','KRON_7','KRON_8','KRON_9','KRON_10','KRON_12', 'KRON_13','KRON_15','KRON_16'};
...
for segment_nr = SELECTED_SEGMENTS   
    ...
    save([CURRPATH,filesep,'INTERPOLATED_DATA.mat'],'KRON_data','ORIGINAL_data','KRON_requested_time','ORIGINAL_requested_time','-v7.3');
    ...
    [perspective_knn_accuracy{kk},perspective_knn_results{kk},perspective_knn_pval{kk}] = perspective_kNN_classification(ISC_matrices{kk},[3,5,7,9],group_ID,50000);   
