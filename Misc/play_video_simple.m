function play_video_simple(FILES,TIMES,DURATION,RATEMOD)
...
if isempty(FILES) || ~iscell(FILES)
   VIDEOS{1} = '/triton/becs/scratch/braindata/kauttoj2/Memento/2015/Stimulus/Memento3part_run1.avi';
   VIDEOS{2} = '/triton/becs/scratch/braindata/kauttoj2/Memento/2015/Stimulus/Memento3part_run2.avi';
   VIDEOS{3} = '/triton/becs/scratch/braindata/kauttoj2/Memento/2015/Stimulus/Memento3part_run3.avi';
   a=FILES;
   FILES=[];
   for i=1:N
       FILES{i}=VIDEOS{a(i)};
